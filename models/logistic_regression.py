...
class LogisticRegressionModel(BaseModel):
    def __init__(self, **kwargs):
        ...
        Args:
            **kwargs: Arguments supplémentaires pour le modèle LogisticRegression
        """
        self.model = LogisticRegression(**{**config.MODEL_CONFIG['logistic_regression'], **kwargs})
    ...
    def build(self, input_shape):
        ...
        # Pour la régression logistique, on a besoin d'aplatir les images
        self.n_features = input_shape[0] * input_shape[1] * input_shape[2]
    
    def _preprocess_data(self, generator):
        """
        Prétraite les données pour la régression logistique.
    ...
    def train(self, train_generator, validation_generator, class_weights=None):
        ...
        Args:
            ...
            class_weights: Poids des classes (non utilisé pour la régression logistique de base)
        """
